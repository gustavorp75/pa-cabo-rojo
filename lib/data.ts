...
export const mapPins: MapPin[] = [
  ...
  // ── NEW BEACHES ──
  {
    ...
    nameEs: 'Los Posos',
    nameEn: 'Los Posos',
    tagEs: '🏖️ Playa · Cabo Rojo',
    tagEn: '🏖️ Beach · Cabo Rojo',
    lat: 18.0011457, lng: -67.2023145,
    emoji: '🏖️', color: '#1a9b8a',
    status: 'great' as const,
    mapLink: 'https://maps.google.com/?q=Los+Posos+Beach+Cabo+Rojo+Puerto+Rico',
  },
  {
    id: 'map-la-mela',
    svgPin: '/images/icons/PinPCR_Red_Beach.webp',
    type: 'beach' as PinType,
    nameEs: 'La Mela Beach',
    nameEn: 'La Mela Beach',
    tagEs: '🏖️ Playa · Cabo Rojo',
    tagEn: '🏖️ Beach · Cabo Rojo',
    lat: 18.0661612, lng: -67.1969532,
    emoji: '🏖️', color: '#1a9b8a',
    status: 'great' as const,
    mapLink: 'https://maps.google.com/?q=La+Mela+Beach+Cabo+Rojo+Puerto+Rico',
  },
  {
    id: 'map-playa-ostiones',
    svgPin: '/images/icons/PinPCR_Yellow_Palma.webp',
    type: 'beach' as PinType,
    nameEs: 'Playa Ostiones',
    nameEn: 'Playa Ostiones',
    tagEs: '🏖️ Tranquila · Norte Cabo Rojo',
    tagEn: '🏖️ Calm · North Cabo Rojo',
    lat: 18.0948770, lng: -67.1949385,
    emoji: '🏖️', color: '#1a9b8a',
    status: 'great' as const,
    mapLink: 'https://maps.google.com/?q=Playa+Ostiones+Cabo+Rojo+Puerto+Rico',
  },
  {
    id: 'map-la-pitahaya',
    svgPin: '/images/icons/PinPCR_Red_Beach.webp',
    type: 'beach' as PinType,
    nameEs: 'Playa La Pitahaya',
    nameEn: 'Playa La Pitahaya',
    tagEs: '🏖️ Playa · Cabo Rojo',
    tagEn: '🏖️ Beach · Cabo Rojo',
    lat: 17.9535333, lng: -67.1329653,
    emoji: '🏖️', color: '#1a9b8a',
    status: 'great' as const,
    mapLink: 'https://maps.google.com/?q=Playa+La+Pitahaya+Cabo+Rojo+Puerto+Rico',
  },
  // ── NEW RESTAURANTS & BARS ──
  {
    ...
    svgPin: '/images/icons/PinPCR_Green_Music.webp',
    type: 'bar' as PinType,
    nameEs: 'Sunsets Bar & Grill',
    nameEn: 'Sunsets Bar & Grill',
    tagEs: 'Bar · El Combate · Vista al mar',
    tagEn: 'Bar · El Combate · Ocean view',
    lat: 17.9819829, lng: -67.2107161,
    emoji: '🍹', color: '#7c3aed',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=Sunsets+Bar+Grill+El+Combate+Cabo+Rojo+Puerto+Rico',
  },
  {
    id: 'map-cabo-beach-house',
    svgPin: '/images/icons/PinPCR_Green_Palma.webp',
    type: 'restaurant' as PinType,
    nameEs: 'Cabo Beach House',
    nameEn: 'Cabo Beach House',
    tagEs: 'Restaurante · $$ · Boquerón',
    tagEn: 'Restaurant · $$ · Boquerón',
    lat: 18.0249083, lng: -67.1735088,
    emoji: '🍽️', color: '#c9943a',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=Cabo+Beach+House+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-la-vaca-enfurecida',
    svgPin: '/images/icons/PinPCR_Green_Palma.webp',
    type: 'restaurant' as PinType,
    nameEs: 'La Vaca Enfurecida',
    nameEn: 'La Vaca Enfurecida',
    tagEs: 'Restaurante · Boquerón',
    tagEn: 'Restaurant · Boquerón',
    lat: 18.0250036, lng: -67.1730424,
    emoji: '🍽️', color: '#c9943a',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=La+Vaca+Enfurecida+Cabo+Rojo+Puerto+Rico',
  },
  {
    id: 'map-pelicans',
    svgPin: '/images/icons/PinPCR_Green_Palma.webp',
    type: 'restaurant' as PinType,
    nameEs: "Pelican's Boquerón",
    nameEn: "Pelican's Boquerón",
    tagEs: 'Restaurante · Boquerón',
    tagEn: 'Restaurant · Boquerón',
    lat: 18.0248199, lng: -67.1726132,
    emoji: '🍽️', color: '#c9943a',
    status: 'open' as const,
    mapLink: "https://maps.google.com/?q=Pelicans+Boqueron+Puerto+Rico",
  },
  {
    id: 'map-tattoos',
    svgPin: '/images/icons/PinPCR_Green_Music.webp',
    type: 'bar' as PinType,
    nameEs: "Tattoo's Bar & Restaurant",
    nameEn: "Tattoo's Bar & Restaurant",
    tagEs: 'Bar · Restaurante · Boquerón',
    tagEn: 'Bar · Restaurant · Boquerón',
    lat: 18.0252076, lng: -67.1729673,
    emoji: '🍹', color: '#7c3aed',
    status: 'open' as const,
    mapLink: "https://maps.google.com/?q=Tattoos+Bar+Restaurant+Boqueron+Puerto+Rico",
  },
  {
    id: 'map-the-copy',
    svgPin: '/images/icons/PinPCR_Green_Palma.webp',
    ...
    tagEs: 'Restaurante · Boquerón',
    tagEn: 'Restaurant · Boquerón',
    lat: 18.0268033, lng: -67.1748903,
    emoji: '🍽️', color: '#c9943a',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=The+Copy+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-el-tiburon',
    svgPin: '/images/icons/PinPCR_Green_Music.webp',
    type: 'bar' as PinType,
    nameEs: 'El Tiburón Bar & Grill',
    nameEn: 'El Tiburón Bar & Grill',
    tagEs: 'Bar · Grill · Boquerón',
    tagEn: 'Bar · Grill · Boquerón',
    lat: 18.0265201, lng: -67.1749506,
    emoji: '🍹', color: '#7c3aed',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=El+Tiburon+Bar+Grill+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-ahava-cafe',
    svgPin: '/images/icons/PinPCR_Green_Palma.webp',
    ...
    tagEs: 'Café · Boquerón',
    tagEn: 'Café · Boquerón',
    lat: 18.0271506, lng: -67.1714188,
    emoji: '☕', color: '#c9943a',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=Ahava+Cafe+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-el-liken',
    svgPin: '/images/icons/PinPCR_Green_Palma.webp',
    ...
    tagEs: 'Restaurante · Boquerón',
    tagEn: 'Restaurant · Boquerón',
    lat: 18.0259215, lng: -67.1744489,
    emoji: '🍽️', color: '#c9943a',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=El+Liken+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-el-congre',
    svgPin: '/images/icons/PinPCR_Green_Palma.webp',
    ...
    tagEs: 'Restaurante · Boquerón',
    tagEn: 'Restaurant · Boquerón',
    lat: 18.0245235, lng: -67.1727061,
    emoji: '🍽️', color: '#c9943a',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=El+Congre+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-el-puente-tropical',
    svgPin: '/images/icons/PinPCR_Green_Music.webp',
    type: 'bar' as PinType,
    nameEs: 'El Puente Tropical',
    nameEn: 'El Puente Tropical',
    tagEs: 'Bar · Restaurante · Boquerón',
    tagEn: 'Bar · Restaurant · Boquerón',
    lat: 18.0245481, lng: -67.1729022,
    emoji: '🍹', color: '#7c3aed',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=El+Puente+Tropical+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-green-parrot',
    svgPin: '/images/icons/PinPCR_Green_Music.webp',
    ...
    tagEs: 'Bar · Boquerón',
    tagEn: 'Bar · Boquerón',
    lat: 18.0253411, lng: -67.1740198,
    emoji: '🍹', color: '#7c3aed',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=Green+Parrot+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-la-garita',
    svgPin: '/images/icons/PinPCR_Green_Palma.webp',
    ...
    tagEs: 'Restaurante · Boquerón',
    tagEn: 'Restaurant · Boquerón',
    lat: 18.0246871, lng: -67.1732586,
    emoji: '🍽️', color: '#c9943a',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=La+Garita+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-el-rincon-del-olvido',
    svgPin: '/images/icons/PinPCR_Green_Palma.webp',
    type: 'restaurant' as PinType,
    nameEs: 'El Rincón Del Olvido',
    nameEn: 'El Rincón Del Olvido',
    tagEs: 'Restaurante · Boquerón',
    tagEn: 'Restaurant · Boquerón',
    lat: 18.0265088, lng: -67.1749283,
    emoji: '🍽️', color: '#c9943a',
    status: 'open' as const,
    mapLink: 'https://maps.google.com/?q=El+Rincon+Del+Olvido+Boqueron+Puerto+Rico',
  },
  {
    id: 'map-sunset-sunrise',
    svgPin: '/images/icons/PinPCR_Green_Music.webp',
    type: 'bar' as PinType,
    nameEs: 'Sunset Sunrise Boquerón',
    nameEn: 'Sunset Sunrise Boquerón',
    tagEs: 'Bar · Boquerón',
    tagEn: 'Bar · Boquerón',
    lat: 18.0248587, lng: -67.1733201,
    emoji: '🍹', color: '#7c3aed',
    status: 'open' as const,
